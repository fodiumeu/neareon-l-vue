...
class NotificationController extends Controller
{
    ...
    private function ctaLabel(string $type): string
    {
        return match ($type) {
            ...
            InternalNotificationType::EventAttendanceRequestReceived->value => 'Event öffnen',
            InternalNotificationType::EventAttendanceRequestAccepted->value => 'Event öffnen',
            InternalNotificationType::EventAttendanceRequestDeclined->value => 'Events entdecken',
            InternalNotificationType::EventAttendeeJoined->value => 'Event öffnen',
