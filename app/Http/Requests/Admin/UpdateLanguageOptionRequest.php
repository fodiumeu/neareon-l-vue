...
class UpdateLanguageOptionRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        $languageOption = $this->route('languageOption');
        ...
        return [
            'code' => [
                ...
                'max:20',
                'alpha_dash:ascii',
                Rule::unique('language_options', 'code')->ignore($languageOption),
            ],
            'label' => [
                'required',
                'string',
                'max:80',
                Rule::unique('language_options', 'label')->ignore($languageOption),
            ],
