...
<template>
    ...
    >
        ...
        <PageHeader
            title="Event erstellen"
            description="Erstelle ein regionales Event für deine Community."
        />
                    ...
                    >
                        <div class="grid gap-2">
                            ...
                            <Input
                                ...
                                required
                                autocomplete="off"
                                placeholder="Community-Treffen Hamburg"
                            />
                            <p class="text-sm text-muted-foreground">
                                Wähle einen klaren Namen, damit andere das
                                Event schnell verstehen.
                            </p>
                        ...
                        >
                            ...
                            >
                                ...
                                {{ processing ? 'Wird erstellt...' : 'Event erstellen' }}
                            </Button>
                        </div>
                    </Form>
                </CardContent>
