...
const selectedCategoryOption = ref(noCategoryValue);
...
<template>
    ...
    >
        <AppBackButton
            fallback="/my-groups"
            label="Zurück zu Meine Gruppen"
            class="hidden md:inline-flex"
        />

        <PageHeader
            title="Gruppe erstellen"
            description="Erstelle eine regionale oder thematische Gruppe für deine Community."
        />
                    ...
                    >
                        <div class="grid gap-2">
                            ...
                            <Input
                                ...
                                required
                                autocomplete="off"
                                placeholder="Laufgruppe Hamburg"
                            />
                            <p class="text-sm text-muted-foreground">
                                Wähle einen klaren Namen, damit andere die
                                Gruppe schnell verstehen.
                            </p>
